...
def run_pkg_commands_monkey_patch(
    project_path, commands, julia_exe=None, depot_path=None, clog=False, no_stderr=False
):
    ...
    if os.path.isfile(project_path):
        project_path = os.path.dirname(
            project_path
        )  # julia commands run 250ms faster if we do this. why?
