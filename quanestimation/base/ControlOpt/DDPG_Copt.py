...
class DDPG_Copt(Control.ControlSystem):
    ...
    def __init__(
        ...
        r"""
        Initialize DDPG control optimization.

        Parameters
        ----------
        savefile : bool, default=False
            Whether to save all control coefficients from all episodes.
        ctrl0 : list, optional
            Initial guesses of control coefficients.
        max_episode : int, default=500
            Number of training episodes.
        layer_num : int, default=3
            Number of neural network layers (including input/output).
        layer_dim : int, default=200
        ...
        load : bool, default=False
            Whether to load control coefficients from ``controls.csv``.
        """
