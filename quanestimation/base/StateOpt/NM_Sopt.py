...
class NM_Sopt(State.StateSystem):
    ...
    def __init__(
        ...
        r"""
        Initialize Nelder-Mead (NM) simplex optimization for state optimization.

        Args:
            savefile (bool, optional): Whether to save all states during
                training. Default ``False``.
            p_num (int, optional): Number of initial states (simplex size).
                Default 10.
            psi0 (list of arrays, optional): Initial guesses of probe states.
                Default ``[]``.
            max_episode (int, optional): Number of episodes. Default 1000.
            ar (float, optional): Reflection constant. Default 1.0.
            ae (float, optional): Expansion constant. Default 2.0.
            ac (float, optional): Contraction constant. Default 0.5.
            as0 (float, optional): Shrink constant. Default 0.5.
