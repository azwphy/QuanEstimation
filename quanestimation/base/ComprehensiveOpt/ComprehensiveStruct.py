...
import quanestimation.base.ComprehensiveOpt as compopt
from quanestimation.base.Common.Common import gramschmidt, SIC
...
def ComprehensiveOpt(savefile=False, method="DE", **kwargs):
    r"""
    Factory function for comprehensive optimization.

    Args:
        savefile (bool, optional): Whether to save all optimized variables during
        ...
        **kwargs: Additional arguments passed to the selected algorithm class
            (see :class:`~quanestimation.ComprehensiveOpt.AD_Compopt`,
            :class:`~quanestimation.ComprehensiveOpt.PSO_Compopt`,
            :class:`~quanestimation.ComprehensiveOpt.DE_Compopt`).

    Returns:
        ComprehensiveSystem: An instance of the selected comprehensive
