...
The example is discussed in detail in [Example 5.1](./guide/guide_Copt.md#example5_1) 
...
The example is discussed in detail in [Example 5.2](./guide/guide_Copt.md#example5_2) 
in control optimization.  
...
The example is discussed in detail in [Example 6.1](./guide/guide_Sopt.md#example6_1) 
...
The example is discussed in detail in [Example 6.2](./guide/guide_Sopt.md#example6_2) 
in state optimization.  
...
The example is discussed in detail in [Example 7.2](./guide/guide_Mopt.md#example7_2) 
...
The example is discussed in detail in [Example 7.3](./guide/guide_Mopt.md#example7_3) 
in measurement optimization.  
...
The example is discussed in detail in [Example 8.1](./guide/guide_Compopt.md#example8_1) 
...
The example is discussed in detail in [Example 8.2](./guide/guide_Compopt.md#example8_2) 
in comprehensive optimization.  
